...
const BLOG = {
  ...
  NOTION_PAGE_ID:
        process.env.NOTION_PAGE_ID || '20c2965c9d294a6c8f7c20dab6839ca7',
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || 'Hi，我是一个普通朝九晚五的打工人, Hi，我是迷途小书童,Hi，我是一个迷途小书童,欢迎来到我的博客🎉',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '心世界打开新世界', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个帮你打开心世界大门的人', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://ylqinggan.com', // 网站地址
